<script>
	import { Button, Toggle, Tabs, TabItem, Select, Modal } from "flowbite-svelte";
	...
	import { countDown, ifStoreMsg, resetControl } from "$lib/shared/stores/common/Store";
			...
			<TabItem class="w-full">
				...
				<div>
					<div class="flex justify-between">
						...
						<Toggle color="blue" checked={$ifStoreMsg} on:change={handleToggle} />
					</div>
