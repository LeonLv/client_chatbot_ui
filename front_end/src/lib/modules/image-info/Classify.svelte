<script lang="ts">
	import EditIcon from "$lib/assets/image-info/svelte/EditIcon.svelte";
	import {
		fetchImageList,
		fetchImagesByType,
		updateLabel,
	...
	import { dummyImgList } from "$lib/shared/constant/Data";
	import { imageList } from "$lib/shared/stores/common/Store";
	import { Avatar, Card, Indicator, Input } from "flowbite-svelte";
